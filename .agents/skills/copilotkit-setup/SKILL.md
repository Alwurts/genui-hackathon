...
- **Codex:** Auto-configured by the plugin's `.mcp.json` -- no setup needed.
...
**Anthropic:** `anthropic/Codex-sonnet-4.5`, `anthropic/Codex-sonnet-4`, `anthropic/Codex-3.7-sonnet`, `anthropic/Codex-opus-4.1`, `anthropic/Codex-opus-4`, `anthropic/Codex-3.5-haiku`
